...
EXPORT Output_GSECRec := RECORD
    ...
    BOOLEAN             Weekend;                                // Enrichment 2
    INTEGER             TotalDaysActive;                        // Total number of days it is active, done by seeing how many weeks it is, then multipling that by the number of days it is active in a week
    BOOLEAN             EconomySeatsOnly                        // Checks for any amount of non-economy seats
END;
